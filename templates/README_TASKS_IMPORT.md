...
### Simple Tasks
```csv
ProjectId,TaskName,Description,Status,Priority,AssignedToUsername,DueDate,EstimatedHours
1,Setup Database,Create MySQL database and tables,To Do,High,admin,2026-03-01,4.0
1,Design UI,Create mockups for main pages,To Do,Medium,designer,2026-03-05,8.0
```
...
1. **Start Simple**: Begin with just ProjectId and TaskName to test the import
