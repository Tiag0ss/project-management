...
import EmptyState from '@/components/old/EmptyState';
import ConfirmAlertModal from '@/components/old/ConfirmAlertModal';
import TaskDetailModal from '@/components/old/TaskDetailModal';
import { TaskAnalyticsCharts } from '@/components/old/reporting/TaskAnalyticsCharts';
import type { TaskAnalyticsData } from '@/lib/reporting/taskAnalytics';
import SegmentedTagBadge from '@/components/old/tags/SegmentedTagBadge';
import InstallAppPrompt from '@/components/old/InstallAppPrompt';
                      ...
                      <div className="bg-amber-500/95 text-white px-3 py-2 rounded-lg">
                        ...
                        <div className="mt-1 flex flex-wrap justify-end gap-2">
                          {pendingApprovals.timeEntries > 0 && pendingApprovals.canApproveTime && (
                            <button
                              onClick={() => router.push(oldPath('/approvals?tab=time'))}
                          ...
                          {pendingApprovals.vacations > 0 && pendingApprovals.canApproveVacations && (
                            <button
                              onClick={() => router.push(oldPath('/approvals?tab=vacations'))}
                              className="px-2.5 py-1 rounded bg-white/20 hover:bg-white/30 text-xs font-medium transition-colors"
                          ...
                          {pendingApprovals.expenses > 0 && pendingApprovals.canApproveExpenses && (
                            <button
                              onClick={() => router.push(oldPath('/approvals?tab=expenses'))}
                              className="px-2.5 py-1 rounded bg-white/20 hover:bg-white/30 text-xs font-medium transition-colors"
                ...
                <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                  ...
                  {summaryStats.tasksToday.length === 0 ? (
                    <div className="text-center py-8">
                      ...
                      <button
                        onClick={() => router.push(oldPath('/planning'))}
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <button
                      onClick={() => router.push(oldPath('/timesheet'))}
                    ...
                    <button
                      onClick={() => router.push(oldPath('/projects'))}
